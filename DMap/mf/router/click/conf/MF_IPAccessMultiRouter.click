...
//Edge interface
port_edge::MF_IPInterface($edge_dev, $edge_dev_ip, 1, arp_tbl); //First core interface
port_edge -> inQ;
...
out_switch[1] //edge bound - IP encap is required
	-> port_edge
...
StaticThreadSched(port_core 1, port_edge 2, gnrs_svc 3, rtg_tbl 4);
