...
#define MF_MAX_REQUEST_SIZE 4096
...
struct mg_request_info {
  ...
  char raw_request[MF_MAX_REQUEST_SIZE];
...
// Return the raw data associated with a request.
char *mg_get_raw_data(struct mg_connection *, int *size);
